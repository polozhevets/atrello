...
class Organizations(object):
    ...
    async def update(self, org_id_or_name, name=None, displayName=None, desc=None, website=None):
        resp = request.put("https://trello.com/1/organizations/%s" % (org_id_or_name), params=dict(key=self._apikey, token=self._token), data=dict(name=name, displayName=displayName, desc=desc, website=website))
        return resp

    async def update_desc(self, org_id_or_name, value):
        resp = request.put("https://trello.com/1/organizations/%s/desc" % (org_id_or_name), params=dict(key=self._apikey, token=self._token), data=dict(value=value))
        return resp

    async def update_displayName(self, org_id_or_name, value):
        resp = request.put("https://trello.com/1/organizations/%s/displayName" % (org_id_or_name), params=dict(key=self._apikey, token=self._token), data=dict(value=value))
        return resp

    async def update_name(self, org_id_or_name, value):
        resp = request.put("https://trello.com/1/organizations/%s/name" % (org_id_or_name), params=dict(key=self._apikey, token=self._token), data=dict(value=value))
        return resp

    async def update_website(self, org_id_or_name, value):
        resp = request.put("https://trello.com/1/organizations/%s/website" % (org_id_or_name), params=dict(key=self._apikey, token=self._token), data=dict(value=value))
        return resp

    async def new(self, name, displayName=None, desc=None, website=None):
        resp = request.post("https://trello.com/1/organizations" % (), params=dict(key=self._apikey, token=self._token), data=dict(name=name, displayName=displayName, desc=desc, website=website))
        return resp

    async def delete(self, org_id_or_name):
        resp = request.delete("https://trello.com/1/organizations/%s" % (org_id_or_name), params=dict(key=self._apikey, token=self._token), data=None)
        return resp
